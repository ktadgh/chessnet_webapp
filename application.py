...
def rating():
    ...
    return render_template("rating2.html", name = elo,svg_base64=svg_base64,white_player=white_player, white_color=white_color,white_points=white_points,black_player = black_player, black_color = black_color, black_points =black_points, white_elo=white_elo, black_elo=black_elo, method_of_victory=method_of_victory)
